...
//peiec
class P9f extends REST_Controller{
  ...
  function __construct(){
    ...
    $this->load->model('visor/p9f_model');
    $this->load->helper('my');
  ...
  public function send_post(){
        ...
        if (!$result) {
          ...
          $msg= array('message' => 'Token key invalid',
            ...
            $flag = $this->p9f_model->insertBatch($array);
    ...
    public function Data_get(){
        ...
        if (!$result) {
          ...
          prettyPrint(json_encode($msg));
            ...
            $data = $this->p9f_model->getData(no_obfuscate($this->get('id_local')),$this->get('predio'));
