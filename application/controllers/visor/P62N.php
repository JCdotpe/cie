...
//peiec
class P62N extends REST_Controller{
  ...
  function __construct(){
    ...
    $this->load->model('visor/P62N_model');
    $this->load->helper('my');
  ...
  public function send_post(){
        ...
        if (!$result) {
          ...
          $msg= array('message' => 'Token key invalid',
            ...
            $flag = $this->P62N_model->insertBatch($array);
    ...
    public function Data_get(){
        ...
        if (!$result) {
          ...
          prettyPrint(json_encode($msg));
            ...
            $data = $this->P62N_model->getData($this->get('id_local'));
