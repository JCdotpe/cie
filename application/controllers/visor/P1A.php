...
//peiec
class P1A extends REST_Controller{
  ...
  function __construct(){
    ...
    $this->load->model('visor/P1A_model');
    $this->load->helper('my');
	...
	public function send_post(){
        ...
        if (!$result) {
          ...
          $msg= array('message' => 'Token key invalid',
            ...
            $flag = $this->P1A_model->insertBatch($array);
    ...
    public function Data_get(){
        ...
        if (!$result) {
          ...
          prettyPrint(json_encode($msg));
            ...
            $data = $this->P1A_model->getData(no_obfuscate($this->get('id_local')),$this->get('predio'));
