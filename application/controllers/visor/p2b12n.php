...
//peiec
class P2b12n extends REST_Controller{
	...
	public function send_post(){
        ...
        if (!$result) {
          ...
          $msg= array('message' => 'Token key invalid',
            ...
            $flag = $this->p2b12n_model->insertBatch($array);
    ...
    public function Data_get(){
        ...
        if (!$result) {
          ...
          prettyPrint(json_encode($msg));
            ...
            $data = $this->p2b12n_model->getData(no_obfuscate($this->get('id_local')),$this->get('predio'));
