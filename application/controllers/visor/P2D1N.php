...
//peiec
class p2d1n extends REST_Controller{
  ...
  function __construct(){
    ...
    $this->load->model('visor/p2d1n_model');
    $this->load->helper('my');
	...
	public function send_post(){
        ...
        if (!$result) {
          ...
          $msg= array('message' => 'Token key invalid',
            ...
            $flag = $this->P2D1N_model->insertBatch($array);
    ...
    public function Data_get(){
        ...
        if (!$result) {
          ...
          prettyPrint(json_encode($msg));
            ...
            $data = $this->P2D1N_model->getData(no_obfuscate($this->get('id_local')), $this->get('Nro_Pred'));
