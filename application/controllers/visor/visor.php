...
//=====================BASICAS==============================
	...
	public function get_data(){
			...
			foreach ($resultado->result() as $fila )
			{
				...
				$respuesta->rows[$i]['cell'] = array('<a href="visor/caratula1/?le='.obfuscate($fila->codigo_de_local).'"><img class="view" style="cursor:pointer;" src="'.base_url('img/search32.png').'" height="16" width="16" /></a>',
