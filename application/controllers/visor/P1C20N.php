...
//peiec
class P1C20N extends REST_Controller{
  ...
  function __construct(){
    ...
    $this->load->model('visor/P1C20N_model');
    $this->load->helper('my');
	...
	public function send_post(){
        ...
        if (!$result) {
          ...
          $msg= array('message' => 'Token key invalid',
            ...
            $flag = $this->P1C20N_model->insertBatch($array);
    ...
    public function Data_get(){
        ...
        if (!$result) {
          ...
          prettyPrint(json_encode($msg));
            ...
            $data = $this->P1C20N_model->getData($this->get('id_local'));
