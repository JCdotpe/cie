...
//========================CAPITULO2========================================
    ...
    function Data_P2_D($codigo_de_local){
        $this->db->select('*');
        $this->db->from('P2_D');
        $this->db->where('codigo_de_local',$codigo_de_local);
        $q = $this->db->get();
    ...
    function Data_P2_E($codigo_de_local){
        $this->db->select('*');
        $this->db->from('P2_E');
        $this->db->where('codigo_de_local',$codigo_de_local);
        $q = $this->db->get();
    ...
    function Data_P2_F($codigo_de_local){
        $this->db->select('*');
        $this->db->from('P2_F');
        $this->db->where('codigo_de_local',$codigo_de_local);
        $q = $this->db->get();
    ...
    function Data_P2_G($codigo_de_local){
        $this->db->select('*');
        $this->db->from('P2_G');
        $this->db->where('codigo_de_local',$codigo_de_local);
        $q = $this->db->get();
     ...
     function Data_P2_G_2N($codigo_de_local){
        $this->db->select('*');
