		  	    	...
		  	    	html+='<table class="table table-bordered">'+
		  	    			'<tbody>'+
			  	    			'<tr>'+
				  	    			...
				  	    			'<td>'+
				  	    				'<input style="width:100px;" type="text" class="form-control Nro_Ed"  value="'+val.Nro_Ed+'" disabled=true>'+
				  	    			'</td>'+
			  	    			'</tr>'+
			  	    			'<tr>'+
				  	    			...
				  	    			'<td>'+
											...
											'<table class="table table-bordered">'+
												...
												'</tr>'+
												'<tr>'+
													'<td> <input style="width:100px;" type="text" class="form-control P6_1_3" value="'+val.P6_1_3+'" disabled=true> </td>'+
													'<td> <input style="width:100px;" type="text" class="form-control P6_1_3_D" value="'+val.P6_1_3+'" disabled=true> </td>'+
												'</tr>'+
											'</table>'+
				  	    			'</td>'+
				  	    		'</tr>'+
				  	    		'<tr>'+
				  	    			...
				  	    			'<td>'+
				  	    				...
				  	    				'<input style="width:100px;" type="text" class="form-control P6_1_4" value="'+val.P6_1_4+'" disabled=true>'+
				  	    			'</td>'+
				  	    		'</tr>'+
				  	    		'<tr>'+
				  	    			...
				  	    			'<td>'+
				  	    					'<label class="checkbox-inline">'+
												'<input type="radio" id="P6_1_51" name="P6_1_5" value="option1" disabled=true> 1. Si'+
											'</label>'+
											'<label class="checkbox-inline">'+
												'<input type="radio" id="P6_1_52" name="P6_1_5" value="option2" disabled=true> 2. No'+
											'</label>'+
				  	    			'</td>'+
				  	    		'</tr>'+
				  	    		'<tr>'+
				  	    			...
				  	    			'<td>'+
				  	    					'<label class="checkbox-inline">'+
												'<input type="radio" id="P6_1_61" name="P6_1_6" value="option1" disabled=true> 1. Si'+
											'</label>'+
											'<label class="checkbox-inline">'+
												'<input type="radio" id="P6_1_62" name="P6_1_6" value="option2" disabled=true> 2. No'+
											'</label>'+
				  	    			'</td>'+
				  	    		'</tr>'+
				  	    		'<tr>'+
				  	    			...
				  	    			'<td>'+
				  	    				'<label class="checkbox-inline">'+
												'<input type="radio" id="P6_1_71" name="P6_1_7" value="option1" disabled=true> 1. Si'+
											'</label>'+
											'<label class="checkbox-inline">'+
												'<input type="radio" id="P6_1_72" name="P6_1_7" value="option2" disabled=true > 2. No'+
										'</label>'+
				  	    			'</td>'+
				  	    		'</tr>'+
				  	    		'<tr>'+
				  	    			...
				  	    			'<td>'+
				  	    				'<input style="width:100px;" type="text" class="form-control P6_1_8" value="'+val.P6_1_8+'"  disabled=true>'+
				  	    			'</td>'+
				  	    		'</tr>';
