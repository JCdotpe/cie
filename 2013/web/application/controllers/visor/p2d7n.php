...
//peiec
class P2d7n extends REST_Controller{
  ...
  function __construct(){
    ...
    $this->load->model('visor/p2d7n_model');
    $this->load->helper('my');
  ...
  public function send_post(){
        ...
        if (!$result) {
          ...
          $msg= array('message' => 'Token key invalid',
            ...
            $flag = $this->p2d7n_model->insertBatch($array);
    ...
    public function Data_get(){
        ...
        if (!$result) {
          ...
          prettyPrint(json_encode($msg));
            ...
            $data = $this->p2d7n_model->getData(no_obfuscate($this->get('id_local')),$this->get('predio'));
