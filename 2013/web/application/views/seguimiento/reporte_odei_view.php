...
{
	$.getJSON(urlRoot('index.php')+'/seguimiento/reporte_odei/view_resultado/' , {vperiodo:periodo}, function(data, textStatus) {
			...
			'<thead>'+
				'<tr>'+
					...
					'<th>Total Colegio Censados (Abs)</th>'+
					'<th>Total Colegio Censados (%)</th>'+
					'<th>Completa (Abs)</th>'+
					'<th>Completa (%)</th>'+
	...
	function exportExcel()
	{
		...
		{ 
	        ...
	        document.forms[0].action=urlRoot('index.php')+"/seguimiento/csvExport/ExportacionODEI?periodo="+codper;
