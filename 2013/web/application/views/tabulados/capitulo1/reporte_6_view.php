			    		...
			    		echo form_open("/tabulados/export");
							...
							echo '<div class="row-fluid" style="overflow:auto;"><table border="1" class="table table-striped box-header" id="tabul" >';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">EDIFICACIONES EVALUADAS PARA SU REFORZAMIENTO SEGÚN NIVEL O MODALIDAD, POR DEPARTAMENTO Y ÁREA</th>';
