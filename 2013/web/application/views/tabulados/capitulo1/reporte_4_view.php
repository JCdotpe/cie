				...
				<!-- INICIO TABULADO -->
			    	<?php
		    			//EVALUAR NEP					
							...
							//***************************************************************************************************************************
							$cant_v = ($NEP == 0) ? 8 : 9; // cantidad de variables (incluir NEP y Total)
								// PREGUNTAS MULTIPLES
			    		...
			    		echo form_open("/tabulados/export");
							...
							echo '<div class="row-fluid" style="overflow:auto;"><table border="1" class="table table-striped box-header" id="tabul" >';
								...
								echo '<thead>';
									...
									echo '<th colspan="'. ( ($NEP == 0) ? ($cant_v - 1)*2 : ($cant_v - 2)*2 ).'" style="text-align:center">Vulnerabilidad por factores de exposición:</th>';
									echo ($NEP>0) ? ('<th colspan="2" rowspan="2" style="vertical-align:middle;text-align:center">No especificado</th>'): '';																																														
									echo '</tr>';
									echo '<tr>'; //***************************************************************************************************************************
										echo '<th colspan="2" style="text-align:center">'. ($variable_1 = 'Cercanía lecho de río, quebrada') .'</th>';										
										echo '<th colspan="2" style="text-align:center">'. ($variable_2 = 'Cercanía a vía ferrea' ) .'</th>';						
										echo '<th colspan="2" style="text-align:center">'. ($variable_3 = 'Cercanía a barranco o precipicio' ) .'</th>';																												
										echo '<th colspan="2" style="text-align:center">'. ($variable_4 = 'Cercanía a cuartel militar o policial' ) .'</th>';																												
										echo '<th colspan="2" style="text-align:center">'. ($variable_5 = 'Erosión fluvial de laderas' ) .'</th>';																												
										echo '<th colspan="2" style="text-align:center">'. ($variable_6 = 'Otro' ) .'</th>';																												
										echo '<th colspan="2" style="text-align:center">'. ($variable_7 = 'Ninguno' ) .'</th>';																												
									echo '</tr>';//***************************************************************************************************************************
