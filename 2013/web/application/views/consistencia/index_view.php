...
<script type="text/javascript">
    ...
    function query_by_sede(sede,provincia,periodo){
        ...
        $.getJSON(urlRoot('index.php')+'/consistencia/procedure/querySede/', {token: getToken(),sede:sede,provincia:provincia,periodo:periodo}, function(data, textStatus) {
...
<div class="row-fluid ">
        ...
        <h4 align="center">CONSISTENCIA</h4>
